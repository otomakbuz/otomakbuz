      ...
      properties: {
        ...
        field_confidence: {
          ...
          properties: {
            ...
            supplier_tax_id: { type: "number" },
            supplier_tax_office: { type: "number" },
            supplier_address: { type: "number" },
            buyer_name: { type: "number" },
            buyer_tax_id: { type: "number" },
            buyer_tax_office: { type: "number" },
            buyer_address: { type: "number" },
            document_type: { type: "number" },
            document_number: { type: "number" },
            issue_date: { type: "number" },
            issue_time: { type: "number" },
            waybill_number: { type: "number" },
